...
function buildPrompt({ mood, energy, stress, motivation, emotions, recentQuotes, genre, isNightMode, prescriptionMode, originalMode }) {
  ...
  const genreMap = {
    great: "【出典】世界の偉人・著名人のみから選ぶ（科学者、芸術家、哲学者、スポーツ選手、作家、思想家、音楽家、起業家など）。",
    anime: `【出典】日本のアニメ・漫画・ゲームのキャラクターから選ぶ。\n対象例：鬼滅の刃、ワンピース、NARUTO、進撃の巨人、ハイキュー！！、鋼の錬金術師、コードギアス、エヴァンゲリオン、スラムダンク、幽☆遊☆白書、HUNTERxHUNTER、僕のヒーローアカデミア、呪術廻戦、銀魂など。\nキャラクター名と作品名を必ず明記。`,
    mix: "【出典】世界の偉人またはアニメ・漫画キャラクター、どちらでもよい。気分により自然にマッチする方を選ぶ。",
  };
